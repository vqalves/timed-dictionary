...
namespace TimedDictionary
{
    public class ExtendTimeConfiguration
    {
        ...
        public ExtendTimeConfiguration(int? duration = null, int? limit = null, IDateTimeProvider dateTimeProvider = null)
        {
            DateTimeProvider = dateTimeProvider ?? DefaultDateTimeProvider.Instance;
        ...
        public static ExtendTimeConfiguration None(IDateTimeProvider dateTimeProvider = null) => new ExtendTimeConfiguration(duration: null, limit: null, dateTimeProvider);
    }
}